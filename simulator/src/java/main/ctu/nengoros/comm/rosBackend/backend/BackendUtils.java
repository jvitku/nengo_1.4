...
public class BackendUtils {
	 ...
	 * @param myRosNode
	 * @param publish
	 * @return new Backend with defined message type and dimensionality registered to myRosNode
	 ...
	 * according to dimensionSizes parsed from Jython script. Until now, it has not been 
	 * tested enough.
	 *  
