...
/**
 * The simplest means of connecting Nengo with ROS - asynchronous communication (no checking, or waiting). 
 * Extend this Neuron in order to implement your own functionality, or use DefaultAsynNeuralModule. 
 * 
 * @author Jaroslav Vitku
 *
 */
public abstract class AbsAsynNeuralModule implements AsynNeuralModule{ 
	...
	public AbsAsynNeuralModule clone(){
		return null;
	}
