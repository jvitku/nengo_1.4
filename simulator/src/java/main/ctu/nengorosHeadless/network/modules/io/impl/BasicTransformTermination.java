 ...
 *
 */
public class BasicTransformTermination implements TransformTermination{
	 ...
	 */
	public BasicTransformTermination(NeuralModule node, String name, float[][] weights) throws
			StructuralException{
		//super(node, name);
