...
public abstract class AbstractTransformMultiTermination implements MultiTermination{
	...
	protected final NeuralModule parent;
	 ...
	 * of Encoder (Node)
	 */
	public AbstractTransformMultiTermination(NeuralModule parent, String name, int outputDimension){
	...
	@Override
	public NeuralModule getNode() { return this.parent;	}
