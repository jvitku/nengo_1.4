...
/**
 * Projection which actually stores the weights 
 * 
 * @author Jaroslav Vitku
 *
 */
public class ProjectionSimpleNode implements Projection {
	 ...
	 */
	public ProjectionSimpleNode(Origin origin, Termination termination, Network network) {
		myOrigin = origin;
