...
# Possible solutions:
#   -add nef.delete Node
#   -run the same model more times, just change the connection weights! XXXXXXXXXX this ine test
#       -add reset to the NeuralModule and to the AbstractHannsNode (simulation channel?)
# 
# 
