...
def buildConfiguration(alpha, gamma, lambdaa, importance):
	...
	rl = rl_sarsa.qlambdaASM("RL", noStateVars=2, noActions=4, noValues=10, logPeriod=100)	
	world = gridworld.benchmarkA("map", mapName="BenchmarkGridWorldNodeD",logPeriod=1000);
