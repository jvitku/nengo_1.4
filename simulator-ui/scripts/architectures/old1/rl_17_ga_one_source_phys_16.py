...
def configure(genome, model):
    ...
    tstates[1][1] = genome[1]
    tstates[1][2] = genome[2]
    tstates[2][0] = genome[3]
    tstates[2][1] = genome[4]
    tstates[2][2] = genome[5] 
    ...
    ############ timportance - all (2x1)
    timportance       = [[0 for j in range(1)] for i in range(2)] # yx
    timportance[0][0] = genome[12]
    timportance[1][0] = genome[13]
