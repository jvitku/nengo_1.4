...
#
# shorter genome - 14 - multiobjective version of rl_14
#
...
def evalInd(indNo, gen, genome, model):
	...
	#print 'prosperity-------------------------- '+str(prosperity)+'   (prosperity of RL '+str(prosp[0])+' )'
	print 'prosperity-------------------------- '+str(prosperity)+'   (prosperity of RL '+str(prosp[0])+'+'+str(prospMo[0])+' )/2'
	return prosperity
...
for i in range(noExperiments):
	FOLDER = 'generated-data/moea/ea_exp_'+str(i)
