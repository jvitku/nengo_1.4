# Shows how an individual Decoder can be set as asynchornous
#   -so the simulator will not wait until some message is received (after each step)
#
# by Jaroslav Vitku
...
print 'Configuration complete, one Decoder (of one) set as asynchronous.'
