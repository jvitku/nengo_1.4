# This demo runs one simulation two times, after each simulaiton, the scenario is restarted.
# Finally, the scenario is erstarted and interactive plots are shown.
#
# by Jaroslav Vitku
...
print "running another simulation"
net.reset()
net.run(t,dt)

print "All done, stoping simulation"
Controls.setVisible(True);
Controls.reset()
net.reset()
net.view()
