...
title='LogicAND'
label='LogicAND'
icon='logic_crisp_gates_and.png'
...
independent=True, useQuick=True):
    ...
    finder = "org.hanns.logic.crisp.gates.impl.AND";

    # create group with a name
    g = NodeGroup(name, independent);    	# create independent group called..
    g.addNode(finder, "logic_crisp_gates_AND", "java");      # start java node and name it finder

    neuron = NeuralModule(name+"_logic_crisp_gates_AND", g) # construct the neural module 
